...
function CategoryManager({ categories: initialCategories }: CategoryManagerProps) {
    ...
    return (
        <div className="space-y-6">
            <form className="space-y-4" onSubmit={handleAddNewCategory}>
                <div className="space-y-2">
                    <Label htmlFor="categoryName" className="mt-5">New Category</Label>
                        ...
                        <TableBody>
                            {categories.map((category) => (
                                <TableRow key={category.id}>
                                    ...
                                    <TableCell>
                                        <Button variant="ghost" size="icon" className="cursor-pointer" onClick={() => handleDeleteCategory(category.id)}>
